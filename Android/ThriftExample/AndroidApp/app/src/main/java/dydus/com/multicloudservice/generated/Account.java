...
public class Account implements org.apache.thrift.TBase<Account, Account._Fields>, java.io.Serializable, Cloneable, Comparable<Account>, android.os.Parcelable {
  ...
  public Account(android.os.Parcel in) {
    this.type = AccountType.findByValue(in.readInt());
